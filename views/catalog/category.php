                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <p><a href="/product/<?php echo $product['id'] ?>/"> <?php echo $product['id'] ?><?php echo $product['name']?></a></p>
                                        <a href="javascript:void(0)" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>В корзину</a>
                                    </div>
